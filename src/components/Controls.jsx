...
export default function Controls({
  ...
  // Built-in demo tracks (paths relative to Vite public root)
  const trialSongs = [
  ...
  // shared outer height for button / select wrappers
  ...
  return (
    <div
      className="w-full max-w-5xl mx-auto bg-white/5 border border-white/10 
                 ...
                 hover:bg-white/10 text-xs sm:text-sm"
    >
      {/* Upload Button */}
      <label
      ...
      <div className={`${controlWrapper} md:flex-1`}>
        <select
          value={selectedTrial}
      ...
      {/* Audio Player (full row on small screens, flexes on larger) */}
      <audio
        ref={audioRef}
        controls
